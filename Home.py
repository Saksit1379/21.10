...
year_class=st.radio("กรุณาเลือกข้อมูล Sex: 0 หญิง, 1 ชาย",(1,2,2,4,5))
field_of_study=st.radio("กรุณาเลือกข้อมูล Sex: 0 หญิง, 1 ชาย",(1,2,2,4,5))
objective=st.radio("กรุณาเลือกข้อมูล Sex: 0 หญิง, 1 ชาย",(1,2,2,4,5))
price=st.radio("กรุณาเลือกข้อมูล Sex: 0 หญิง, 1 ชาย",(1,2,2,4,5))
store=st.radio("กรุณาเลือกข้อมูล Sex: 0 หญิง, 1 ชาย",(1,2,2,4,5))
pay=st.radio("กรุณาเลือกข้อมูล Sex: 0 หญิง, 1 ชาย",(1,2,2,4,5))
period=st.radio("กรุณาเลือกข้อมูล Sex: 0 หญิง, 1 ชาย",(1,2,2,4,5))
motivation=st.radio("กรุณาเลือกข้อมูล Sex: 0 หญิง, 1 ชาย",(1,2,2,4,5))
motivation=st.radio("กรุณาเลือกข้อมูล Sex: 0 หญิง, 1 ชาย",(1,2,2,4,5))
parent_income=st.radio("กรุณาเลือกข้อมูล Sex: 0 หญิง, 1 ชาย",(1,2,2,4,5))
