...
sex=st.radio(" Sex: 0 หญิง, 1 ชาย",(0, 1))
...
motivation=st.radio("มูลเหตุจูงใจหรือบุคคลใดที่มีอิทธิพลต่อกำรตัดสินใจเลือกซื้อ",(1,2,2,4,5))
income=st.radio("รายได้ของผู้ปกครอง",(1,2,2,4,5))
